...
public class DocumentPlanRoom extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.document_plan_room);
    ...
    private void init() {
        context = this;
        activity = DocumentPlanRoom.this;
    ...
    void confirmDialog() {
        ...
        builder.setTitle("Сохранить план комнаты?");
        builder.setMessage("Вы уверены, что хотите сохранить план комнаты?");
